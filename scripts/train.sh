...
OUT_PATH=/home/rishabh/Desktop/Experiments/VSR-LLM/checkpoints/trained/Llama2_proj_test_blip2_qformer_new    # output path to save
...
PROJECTOR_TYPE=${PROJECTOR_TYPE:-blip2_qformer}
