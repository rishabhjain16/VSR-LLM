...
MODEL_PATH=/home/rijain@ad.mee.tcd.ie/Experiments/proj/VSR-LLM/checkpoints/projector_test/phi4_lrs3_linear/checkpoints/checkpoint_best.pt
...
OUT_PATH=${ROOT}/checkpoints/decode/decode_phi4_lrs3_linear   # output path to save results
