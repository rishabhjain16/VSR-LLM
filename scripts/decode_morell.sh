...
#LLM_PATH=${ROOT}/checkpoints/phi-4
LLM_PATH=${ROOT}/checkpoints/Meta-Llama-3-8B    # path to Llama 3 model

DATA_ROOT=/data/ssd2/data_rishabh/lrs3/433h_data
...
#MODEL_PATH=/data/ssd2/data_rishabh/VSR-LLM_trained_ckps/old/vicuna7b_lrs3/checkpoints/checkpoint_best.pt    # path to trained model with Llama 3
...
MODEL_PATH=/home/rijain@ad.mee.tcd.ie/Experiments/proj/VSR-LLM/checkpoints/projector_test/llama3_lrs3_linear/checkpoints/checkpoint_best.pt
...
OUT_PATH=${ROOT}/checkpoints/decode/decode_llama3_lrs3_linear   # output path to save results
