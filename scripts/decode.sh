...
MODEL_PATH=/home/rishabh/Desktop/Experiments/VSR-LLM/checkpoints/trained/llama2_lrs3_linear_ctc_projector_new/checkpoints/checkpoint_best.pt   # path to trained model with Llama 3
