...
MODEL_PATH=/home/rishabh/Desktop/Experiments/VSR-LLM/checkpoints/trained/test_vsp_llm2/checkpoints/checkpoint_best.pt   # path to trained model with Llama 3
