...
MODEL_PATH=/home/rishabh/Desktop/Experiments/VSR-LLM/checkpoints/trained/Llama2_proj_linear_with_ctc/checkpoints/checkpoint_best.pt   # path to trained model with Llama 3
